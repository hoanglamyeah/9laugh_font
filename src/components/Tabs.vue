    ...
    <div class="x-grid">
      ...
      <div class="tabs-content" data-tabs-content="tabs">
        ...
        <div class="tabs-panel" id="panel3d">
          <p>Curabitur sit amet dolor vitae justo vulputate semper in quis ipsum. Proin dignissim, eros vitae aliquet
            pellentesque, tortor odio molestie felis, in tempor lectus metus nec lacus.</p>
        </div>
      </div>
    </div>
  </div>
